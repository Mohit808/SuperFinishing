...
public class AdminServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (!name.isEmpty()&&!details.isEmpty()){
                    if (imageUri!=null&& imageUriBanner!=null)
                    {
                        ...
                        ProgressDialog progressDialog=new ProgressDialog(AdminServiceActivity.this);
                        progressDialog.show();
                        String pushKey = FirebaseDatabase.getInstance().getReference().push().getKey();

                        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("serviceCategory").child(pushKey);
                                ...
                                if (task.isSuccessful()){
                                    storageReference.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                        ...
                                        public void onComplete(@NonNull Task<Uri> task) {
                                            StorageReference storageReference2 = FirebaseStorage.getInstance().getReference().child("serviceCategory").child(pushKey+"banner");
                                                    ...
                                                    if (taskx.isSuccessful()){
                                                        storageReference2.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Uri> taskc) {
                                                                ...
                                                                FirebaseDatabase.getInstance().getReference().child("serviceCategory").child(pushKey).setValue(hashMap);
                    ...
                    Toast.makeText(AdminServiceActivity.this, "category name and details cant be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buttonSaveSubCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!name.isEmpty()){
                    ...
                    StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("serviceSubCategory").child(pushKey);
                            ...
                            if (task.isSuccessful()){
                                storageReference.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                    ...
                                    public void onComplete(@NonNull Task<Uri> task) {
                                        ...
                                        hashMap.put("name",name);
                                        hashMap.put("image",task.getResult().toString());
                                        FirebaseDatabase.getInstance().getReference().child("serviceSubCategory").child(pushKey).setValue(hashMap);
                                        editTextCategory.setText("");
                                        imageUri=null;
                                        imageUriBanner=null;
        ...
        categoryField.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dialog dialog = new Dialog(AdminServiceActivity.this);
                dialog.setContentView(R.layout.dialog_view);
                RecyclerView recyclerView = dialog.findViewById(R.id.recyclerView14);
                recyclerView.setLayoutManager(new LinearLayoutManager(AdminServiceActivity.this));
                FirebaseDatabase.getInstance().getReference().child("serviceCategory").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        recyclerView.setAdapter(new AdapterDialog(AdminServiceActivity.this,listCategory,categoryFieldText,dialog));
                        dialog.show();
                    }
